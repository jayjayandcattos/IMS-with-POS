...
REPLACE INTO `customers` (`id`, `Name`, `PhoneNumber`) VALUES
(98, 'Gerald', '9996830717'),
(29, 'Ronamae Salvador', '9996830717'),
(30, 'Dan Matthew Bercasio', '9996830717'),
(92, 'Jed', '9991123234');
...
REPLACE INTO `purchase` (`id`, `invoice`, `shop and address`, `total_items`, `total_amount`, `date_of_purchase`) VALUES
(1, '123XB123', 'Rebisco', 50, 200000.00, '30/05/2023'),
(2, '231XA231', 'BigBrew', 100, 100000.00, '29/05/2023');
...
CREATE TABLE `billing` (   `item_number` varchar(255) NOT NULL,   `quantity` int(25) NOT NULL,   `price` double(50,2) NOT NULL,   `total_amount` double(50,2) NOT NULL,   `id` int(11) NOT NULL ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4
